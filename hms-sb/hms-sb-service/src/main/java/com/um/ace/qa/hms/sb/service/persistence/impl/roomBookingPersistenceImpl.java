...
import com.um.ace.qa.hms.sb.model.impl.roomBookingImpl;
import com.um.ace.qa.hms.sb.model.impl.roomBookingModelImpl;
 ...
 * @generated
 */
@Component(service = roomBookingPersistence.class)
@ProviderType
public class roomBookingPersistenceImpl
	extends BasePersistenceImpl<roomBooking> implements roomBookingPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>roomBookingUtil</code> to access the room booking persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		roomBookingImpl.class.getName();
	 ...
	 */
	@Override
	public List<roomBooking> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<roomBooking> findByUuid(
	...
	public List<roomBooking> findByUuid(
		...
		if (retrieveFromCache) {
			list = (List<roomBooking>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (roomBooking roomBooking : list) {
					if (!uuid.equals(roomBooking.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			try {
				...
				if (!pagination) {
					list = (List<roomBooking>)QueryUtil.list(
	...
	public roomBooking fetchByUuid_Last(
		...
		List<roomBooking> list = findByUuid(
	...
	public roomBooking[] findByUuid_PrevAndNext(
		...
		roomBooking roomBooking = findByPrimaryKey(bookingID);
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(
				session, roomBooking, uuid, orderByComparator, true);

			array[1] = roomBooking;

			array[2] = getByUuid_PrevAndNext(
				session, roomBooking, uuid, orderByComparator, false);
	...
	protected roomBooking getByUuid_PrevAndNext(
		Session session, roomBooking roomBooking, String uuid,
		OrderByComparator<roomBooking> orderByComparator, boolean previous) {
		...
		if (orderByComparator != null) {
			for (Object orderByConditionValue :
					orderByComparator.getOrderByConditionValues(roomBooking)) {
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(roomBooking.uuid IS NULL OR roomBooking.uuid = '')";
	...
	public roomBooking fetchByUUID_G(
		...
		if (result instanceof roomBooking) {
			...
			if (!Objects.equals(uuid, roomBooking.getUuid()) ||
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"roomBooking.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(roomBooking.uuid IS NULL OR roomBooking.uuid = '') AND ";
	 ...
	 */
	@Override
	public List<roomBooking> findByUuid_C(
	...
	public roomBooking findByUuid_C_First(
		...
		roomBooking roomBooking = fetchByUuid_C_First(
	...
	public roomBooking fetchByUuid_C_First(
		...
		List<roomBooking> list = findByUuid_C(
	...
	public roomBooking findByUuid_C_Last(
		...
		roomBooking roomBooking = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public roomBooking[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, roomBooking, uuid, companyId, orderByComparator, true);

			array[1] = roomBooking;

			array[2] = getByUuid_C_PrevAndNext(
				session, roomBooking, uuid, companyId, orderByComparator,
				false);
	...
	protected roomBooking getByUuid_C_PrevAndNext(
		Session session, roomBooking roomBooking, String uuid, long companyId,
		OrderByComparator<roomBooking> orderByComparator, boolean previous) {
	...
	public void cacheResult(roomBooking roomBooking) {
		entityCache.putResult(
			entityCacheEnabled, roomBookingImpl.class,
			roomBooking.getPrimaryKey(), roomBooking);
	...
	public void cacheResult(List<roomBooking> roomBookings) {
		for (roomBooking roomBooking : roomBookings) {
			if (entityCache.getResult(
					entityCacheEnabled, roomBookingImpl.class,
					roomBooking.getPrimaryKey()) == null) {
	...
	public void clearCache() {
		entityCache.clearCache(roomBookingImpl.class);
	...
	public void clearCache(roomBooking roomBooking) {
		entityCache.removeResult(
			entityCacheEnabled, roomBookingImpl.class,
			roomBooking.getPrimaryKey());

		finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITH_PAGINATION);
		finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);

		clearUniqueFindersCache((roomBookingModelImpl)roomBooking, true);
	}
	...
	protected void cacheUniqueFindersCache(
		roomBookingModelImpl roomBookingModelImpl) {

		Object[] args = new Object[] {
			roomBookingModelImpl.getUuid(), roomBookingModelImpl.getGroupId()
		};

		finderCache.putResult(
			_finderPathCountByUUID_G, args, Long.valueOf(1), false);
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, roomBookingModelImpl, false);
	}

	protected void clearUniqueFindersCache(
		roomBookingModelImpl roomBookingModelImpl, boolean clearCurrent) {

		if (clearCurrent) {
			Object[] args = new Object[] {
				roomBookingModelImpl.getUuid(),
				roomBookingModelImpl.getGroupId()
			};
	...
	public roomBooking create(long bookingID) {
		...
		roomBooking.setPrimaryKey(bookingID);

		String uuid = PortalUUIDUtil.generate();

		roomBooking.setUuid(uuid);

		roomBooking.setCompanyId(companyProvider.getCompanyId());
	 ...
	 */
	@Override
	public roomBooking remove(long bookingID)
		throws NoSuchroomBookingException {
	...
	public roomBooking remove(Serializable primaryKey)
		...
		try {
			...
			roomBooking roomBooking = (roomBooking)session.get(
			...
			if (roomBooking == null) {
				...
				throw new NoSuchroomBookingException(
	...
	protected roomBooking removeImpl(roomBooking roomBooking) {
		...
		try {
			...
			if (!session.contains(roomBooking)) {
				roomBooking = (roomBooking)session.get(
					roomBookingImpl.class, roomBooking.getPrimaryKeyObj());
			}
	...
	public roomBooking updateImpl(roomBooking roomBooking) {
		...
		if (!(roomBooking instanceof roomBookingModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(roomBooking.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(roomBooking);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in roomBooking proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom roomBooking implementation " +
					roomBooking.getClass());
		}

		roomBookingModelImpl roomBookingModelImpl =
			(roomBookingModelImpl)roomBooking;
		...
		if (isNew && (roomBooking.getCreateDate() == null)) {
			if (serviceContext == null) {
				roomBooking.setCreateDate(now);
			}
			else {
				roomBooking.setCreateDate(serviceContext.getCreateDate(now));
			}
		}

		if (!roomBookingModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				roomBooking.setModifiedDate(now);
			}
			else {
				roomBooking.setModifiedDate(
		...
		try {
			...
			if (roomBooking.isNew()) {
				...
				roomBooking = (roomBooking)session.merge(roomBooking);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (!_columnBitmaskEnabled) {
			...
			Object[] args = new Object[] {roomBookingModelImpl.getUuid()};
		...
		entityCache.putResult(
			entityCacheEnabled, roomBookingImpl.class,
			roomBooking.getPrimaryKey(), roomBooking, false);

		clearUniqueFindersCache(roomBookingModelImpl, false);
		cacheUniqueFindersCache(roomBookingModelImpl);
	...
	/**
	 * Returns the room booking with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the room booking
	...
	protected String getSelectSQL() {
		return _SQL_SELECT_ROOMBOOKING;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return roomBookingModelImpl.TABLE_COLUMNS_MAP;
	}
	...
	public void activate() {
		roomBookingModelImpl.setEntityCacheEnabled(entityCacheEnabled);
		roomBookingModelImpl.setFinderCacheEnabled(finderCacheEnabled);

		_finderPathWithPaginationFindAll = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, roomBookingImpl.class,
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			roomBookingModelImpl.CREATEDATE_COLUMN_BITMASK);
	...
	public void deactivate() {
		entityCache.removeCache(roomBookingImpl.class.getName());
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.um.ace.qa.hms.sb.model.roomBooking"),
			true);
	}
	...
	private static final String _SQL_SELECT_ROOMBOOKING =
		"SELECT roomBooking FROM roomBooking roomBooking";

	private static final String _SQL_SELECT_ROOMBOOKING_WHERE =
		"SELECT roomBooking FROM roomBooking roomBooking WHERE ";

	private static final String _SQL_COUNT_ROOMBOOKING =
		"SELECT COUNT(roomBooking) FROM roomBooking roomBooking";

	private static final String _SQL_COUNT_ROOMBOOKING_WHERE =
		"SELECT COUNT(roomBooking) FROM roomBooking roomBooking WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS = "roomBooking.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No roomBooking exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No roomBooking exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		roomBookingPersistenceImpl.class);
