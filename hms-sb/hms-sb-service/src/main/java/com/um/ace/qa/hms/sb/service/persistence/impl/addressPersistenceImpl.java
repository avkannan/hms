...
import com.um.ace.qa.hms.sb.model.impl.addressImpl;
import com.um.ace.qa.hms.sb.model.impl.addressModelImpl;
...
public class addressPersistenceImpl
	...
	public address[] findByUuid_PrevAndNext(
		...
		address address = findByPrimaryKey(roomID);
	...
	public void clearCache(address address) {
		...
		clearUniqueFindersCache((addressModelImpl)address, true);
	}
	...
	protected void clearUniqueFindersCache(
		addressModelImpl addressModelImpl, boolean clearCurrent) {
	...
	public address updateImpl(address address) {
		...
		clearUniqueFindersCache(addressModelImpl, false);
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			addressModelImpl.ROOMNO_COLUMN_BITMASK);
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.um.ace.qa.hms.sb.model.address"),
			true);
	}
