...
import com.um.ace.qa.hms.sb.service.addressLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.um.ace.qa.hms.sb.service.impl.addressLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.um.ace.qa.hms.sb.service.impl.addressLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class addressLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>addressLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.um.ace.qa.hms.sb.service.addressLocalServiceUtil</code>.
	 */
	...
	public address createaddress(long roomID) {
		return addressPersistence.create(roomID);
	}
	...
	public address deleteaddress(long roomID) throws PortalException {
		return addressPersistence.remove(roomID);
	}
	...
	public address fetchaddress(long roomID) {
		return addressPersistence.fetchByPrimaryKey(roomID);
	}
	...
	public address getaddress(long roomID) throws PortalException {
		return addressPersistence.findByPrimaryKey(roomID);
	}
