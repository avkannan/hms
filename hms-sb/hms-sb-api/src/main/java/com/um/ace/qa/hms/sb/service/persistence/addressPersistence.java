...
import com.um.ace.qa.hms.sb.exception.NoSuchaddressException;
...
public interface addressPersistence extends BasePersistence<address> {
	 ...
	 */
	public address create(long roomID);
	 ...
	 * @throws NoSuchaddressException if a address with the primary key could not be found
	 */
	public address remove(long roomID) throws NoSuchaddressException;
	 ...
	 * @throws NoSuchaddressException if a address with the primary key could not be found
	 */
	public address findByPrimaryKey(long roomID) throws NoSuchaddressException;
	 ...
	 */
	public address fetchByPrimaryKey(long roomID);
