...
/**
 * This class is used by SOAP remote services, specifically {@link com.um.ace.qa.hms.sb.service.http.room_newServiceSoap}.
 *
 * @author Brian Wing Shun Chan
 * @generated
 */
@ProviderType
public class room_newSoap implements Serializable {

	public static room_newSoap toSoapModel(room_new model) {
		room_newSoap soapModel = new room_newSoap();
	...
	public static room_newSoap[] toSoapModels(room_new[] models) {
		room_newSoap[] soapModels = new room_newSoap[models.length];
	...
	public static room_newSoap[][] toSoapModels(room_new[][] models) {
		room_newSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new room_newSoap[models.length][models[0].length];
		}
		else {
			soapModels = new room_newSoap[0][0];
		}
	...
	public static room_newSoap[] toSoapModels(List<room_new> models) {
		List<room_newSoap> soapModels = new ArrayList<room_newSoap>(
			models.size());

		for (room_new model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new room_newSoap[soapModels.size()]);
	}
